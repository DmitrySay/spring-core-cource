...
public class NTicketStrategyTest {

    @Autowired
    NTicketStrategy nTicketStrategy;
    ...
    @Before
    public void init() {
        user1 = new User(1L, "Andrey", "Pupkin", "andrey@epam.com");
    ...
    public void calculateDiscountTest() {
        byte generallDiscountPercent = nTicketStrategy.calculateDiscount(user1, event, airDateTime, 99);
        byte expected = 4;
        Assert.assertEquals(expected, generallDiscountPercent);
