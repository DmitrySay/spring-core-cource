...
public class CounterAspectTest {
    ...
    public void init() {
        ...
        ticket1.setUser(userEtalon);
        ticket2.setUser(userEtalon);
    ...
    public void saveEventValueCouterByNameTest() {
        ...
        eventService.getByName("New_Year_Party");
        eventService.getByName("New_Year_Party");
        eventService.getByName("121");
        Long result  = counterAspectDao.eventsByNameStorageGetAll().get(0).get("New_Year_Party");
